								...
								<c:forEach items="${allOrders}" var="o" varStatus="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												...
												<c:if test="${o.state==2}">
													<a href="/AdminOrderServlet?method=updateOrderByOid&oid=${o.oid}">发货</a>
												</c:if>
    ...
    $(".myClass").click(function() {
        ...
        if(txt=="订单详情"){
            ...
            $.post(url,obj,function (data) {
                $tb.html("");
                var td1= " <tr><th>商品</th><th>名称</th><th>单价</th><th>数量</th></tr>";
                $tb.append(td1);
                $.each(data,function (i,obj) {
                    var td = "<tr><td><img src='"+obj.product.pimage+"' width='50px'/></td><td>"+obj.product.pname+"</td><td>"+obj.product.shop_price+"</td><td>"+obj.quantity+"</td></tr>";
                    $tb.append(td);
                })
            },"json");
            this.value="关闭";
